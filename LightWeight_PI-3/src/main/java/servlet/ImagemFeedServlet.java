...
@WebServlet("/imagens-feed/*")
public class ImagemFeedServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	private static final String BASE_PATH = "C:\\imagens\\imagens-feed"; // Altere para o caminho do seu diretório externo
